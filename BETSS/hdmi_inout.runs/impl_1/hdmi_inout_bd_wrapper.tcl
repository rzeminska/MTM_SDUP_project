...
set rc [catch {
  ...
  add_files -quiet C:/Users/DELL/Desktop/test/MTM_SDUP_project/BETSS/hdmi_inout.runs/synth_1/hdmi_inout_bd_wrapper.dcp
  ...
  set_param project.isImplRun true
  link_design -top hdmi_inout_bd_wrapper -part xc7z020clg400-1
  set_param project.isImplRun false
  write_hwdef -force -file hdmi_inout_bd_wrapper.hwdef
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force hdmi_inout_bd_wrapper_opt.dcp
  create_report "impl_1_opt_report_drc_0" "report_drc -file hdmi_inout_bd_wrapper_drc_opted.rpt -pb hdmi_inout_bd_wrapper_drc_opted.pb -rpx hdmi_inout_bd_wrapper_drc_opted.rpx"
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force hdmi_inout_bd_wrapper_placed.dcp
  create_report "impl_1_place_report_io_0" "report_io -file hdmi_inout_bd_wrapper_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file hdmi_inout_bd_wrapper_utilization_placed.rpt -pb hdmi_inout_bd_wrapper_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file hdmi_inout_bd_wrapper_control_sets_placed.rpt"
