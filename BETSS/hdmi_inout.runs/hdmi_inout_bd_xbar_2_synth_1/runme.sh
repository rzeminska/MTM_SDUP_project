...
HD_PWD='C:/Users/DELL/Desktop/test/MTM_SDUP_project/BETSS/hdmi_inout.runs/hdmi_inout_bd_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_inout_bd_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_inout_bd_xbar_2.tcl
