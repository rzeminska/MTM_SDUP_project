...
HD_PWD='C:/Users/DELL/Desktop/test/MTM_SDUP_project/BETSS/hdmi_inout.runs/hdmi_inout_bd_v_vid_in_axi4s_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_inout_bd_v_vid_in_axi4s_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_inout_bd_v_vid_in_axi4s_0_0.tcl
