...
HD_PWD='C:/Users/DELL/Desktop/test/MTM_SDUP_project/BETSS/hdmi_inout.runs/hdmi_inout_bd_axi_vdma_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_inout_bd_axi_vdma_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_inout_bd_axi_vdma_0_1.tcl
