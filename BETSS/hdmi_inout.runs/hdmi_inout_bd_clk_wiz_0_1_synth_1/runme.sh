...
HD_PWD='C:/Users/DELL/Desktop/BETSS/hdmi_inout_po_konsultacji/hdmi_inout/hdmi_inout.runs/hdmi_inout_bd_clk_wiz_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_inout_bd_clk_wiz_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_inout_bd_clk_wiz_0_1.tcl
